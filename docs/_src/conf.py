...
latex_documents = [
    (master_doc, "Flyte.tex", "Flyte Documentation", "Flyte Authors",
     "manual"),
]
...
# intersphinx configuration. Uncomment the repeats with the local paths and
# update your username to help with local development.
intersphinx_mapping = {
...
import_projects_config = {
    "clone_dir": "_projects",
    "flytekit_api_dir": "_import/flytekit/",
...
flyteidl_local_path = os.environ.get("FLYTEIDL_LOCAL_PATH", None)
...
import_projects = [
    {
        "name": "flytekit",
        "source": flytekit_local_path
                or "https://github.com/flyteorg/flytekit",
        "docs_path": "docs/source",
        "dest": "api/flytekit",
        "cmd": [
            ["mkdir", "-p", import_projects_config["flytekit_api_dir"]],
            ["cp", "-R", f"{flytekit_path}/flytekit",
             import_projects_config["flytekit_api_dir"]],
            ["cp", "-R", f"{flytekit_path}/plugins",
             import_projects_config["flytekit_api_dir"]],
    ...
    {
        "name": "flytectl",
        "source": flytectl_local_path
                or "https://github.com/flyteorg/flytectl",
        "docs_path": "docs/source",
        "dest": "flytectl",
    ...
    # {
    #     "name": "flyteidl",
    #     "source": flyteidl_local_path
    #             or "https://github.com/flyteorg/flyte",
    #     "docs_path": "protos",
...
class CustomWarningSuppressor(logging.Filter):
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        ...
        # TODO: These are all warnings that should be fixed as follow-ups to
        # the monodocs build project.
        filter_out = (
            "duplicate label",
